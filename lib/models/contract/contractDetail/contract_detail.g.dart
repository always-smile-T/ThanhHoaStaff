...
ShowContractModel _$ShowContractModelFromJson(Map<String, dynamic> json) =>
    ShowContractModel(
      ...
      imgList: (json['imgList'] as List<dynamic>?)
          ...
          .toList(),
      showStaffModel: json['showStaffModel'] as List<dynamic>?,
      showCustomerModel: json['showCustomerModel'] as List<dynamic>?,
      showStoreModel: json['showStoreModel'] as List<dynamic>?,
      showPaymentTypeModel: json['showPaymentTypeModel'] as List<dynamic>?,
